...
if(l4CC419CD_0)
{
	...
	var l49CC28B6_0 = sprite_get_width(spr_hud_heart);
	var l49CC28B6_1 = 0;
	for(var l49CC28B6_2 = obj_player.hearts; l49CC28B6_2 > 0; --l49CC28B6_2) {
		draw_sprite(spr_hud_heart, 0, 0 + l49CC28B6_1, 0);
		l49CC28B6_1 += l49CC28B6_0;
	}
}